...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeHp, SchemeMid, SchemeNormHighlight, SchemeSelHighlight,
...
usage(void)
{
	fputs("usage: dmenu [-bfivrP] [-l lines] [-h height] [-p prompt] [-fn font] [-m monitor]\n"
	      "             [-x xoffset] [-y yoffset] [-z width]\n"
	      "             [-nb color] [-nf color] [-sb color] [-sf color]\n"
	      "             [-nhb color] [-nhf color] [-shb color] [-shf color]\n"
		  "             [-hb color] [-hf color] [-hp items]\n"
	      "             [-w windowid] [-n number] [-dy command] [-it text]\n", stderr);
	exit(1);
}
